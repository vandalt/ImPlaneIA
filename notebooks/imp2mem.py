...
def Calib_NRM(nrm, nrm_c, method='med'):
...
if __name__ == "__main__":
    ...
    """
    objecttextdir_c = "cal_ov3/c_myscene_disk_r=100mas__F430M_81_flat_x11__00_mir" # Calibrator result ImPlaneIA
    objecttextdir_t = "" # Target result ImPlaneIA
    
    nrm_t = main_ansou(nh=7, txtdir=objecttextdir_c, verbose=False)
    nrm_c = main_ansou(nh=7, txtdir=objecttextdir_c, verbose=False)
    """

    OV = 11 # investigate different oversampling
    objecttextdir_c = "Simulated_data/cal_ov{:d}/c_dsk_100mas__F430M_81_flat_x11__00_mir".format(OV) # Calibrator result ImPlaneIA
    objecttextdir_t = "Simulated_data/tgt_ov{:d}/t_dsk_100mas__F430M_81_flat_x11__00_mir".format(OV) # Target result ImPlaneIA
